...
// node_modules/sanity/lib/_chunks/structure-gHZwXvhJ.js
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({ locale: "en-US", namespace: structureLocaleNamespace, resources: () => import("./resources-7hAPJyyn-M7WDJVW4.js") });
...
var ReferenceChildLink = (0, import_react3.forwardRef)(function ReferenceChildLink2(_ref6, ref) {
...
var _d$5;
var _e$3;
var ChevronWrapper = ut(Box)(_a$H || (_a$H = __template$H(["\n  margin-left: auto;\n"])));
var CrossDatasetReferencesDetails = ut.details(_b$i || (_b$i = __template$H(["\n  flex: none;\n\n  &[open] ", " {\n    transform: rotate(180deg);\n  }\n"])), ChevronWrapper);
var CrossDatasetReferencesSummary = ut.summary(_c$8 || (_c$8 = __template$H(["\n  list-style: none;\n\n  &::-webkit-details-marker {\n    display: none;\n  }\n"])));
var Table = ut.table(_d$5 || (_d$5 = __template$H(["\n  width: 100%;\n  text-align: left;\n  padding: 0 ", ";\n  border-collapse: collapse;\n\n  th {\n    padding: ", ";\n  }\n\n  td {\n    padding: 0 ", ";\n  }\n\n  tr > *:last-child {\n    text-align: right;\n  }\n"])), (_ref7) => {
  let { theme } = _ref7;
...
var DocumentIdFlex = ut(Flex)(_e$3 || (_e$3 = __template$H(["\n  min-height: 33px;\n"])));
...
function ConfirmDeleteDialogBody(_ref10) {
  let { crossDatasetReferences, internalReferences, documentTitle, totalCount, action, datasetNames, hasUnknownDatasetNames, onReferenceLinkClick } = _ref10;
  const schema2 = useSchema();
  ...
  return (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", gap: 4, children: [(0, import_jsx_runtime2.jsx)(Card, { padding: 3, radius: 2, tone: "caution", flex: "none", children: (0, import_jsx_runtime2.jsxs)(Flex, { children: [(0, import_jsx_runtime2.jsx)(Text, { "aria-hidden": "true", size: 1, children: (0, import_jsx_runtime2.jsx)(WarningOutlineIcon, {}) }), (0, import_jsx_runtime2.jsx)(Box, { flex: 1, marginLeft: 3, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { i18nKey: "confirm-delete-dialog.referring-document-count.text", components: { DocumentTitle: () => documentTitle }, t, values: { count: totalCount } }) }) })] }) }), (0, import_jsx_runtime2.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { i18nKey: "confirm-delete-dialog.referring-documents-descriptor.text", t, context: action, components: { DocumentTitle: () => documentTitle } }) }) }), (0, import_jsx_runtime2.jsx)(Card, { radius: 2, shadow: 1, flex: "auto", padding: 2, children: (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", children: [internalReferences.totalCount > 0 && (0, import_jsx_runtime2.jsxs)(Stack, { as: "ul", marginBottom: 2, space: 2, "data-testid": "internal-references", children: [internalReferences == null ? void 0 : internalReferences.references.map((item) => (0, import_jsx_runtime2.jsx)(Box, { as: "li", children: renderPreviewItem(item) }, item._id)), internalReferences.totalCount > internalReferences.references.length && (0, import_jsx_runtime2.jsx)(Box, { as: "li", padding: 3, children: (0, import_jsx_runtime2.jsx)(OtherReferenceCount, { ...internalReferences }) })] }), crossDatasetReferences.totalCount > 0 && (0, import_jsx_runtime2.jsxs)(CrossDatasetReferencesDetails, { "data-testid": "cross-dataset-references", style: {
    ...
    let { projectId, datasetName, documentId } = _ref11;
    return (
...
var _a$G;
var _b$h;
var DialogBody = ut(Box)(_a$G || (_a$G = __template$G(["\n  box-sizing: border-box;\n"])));
var LoadingContainer = ut(Flex).attrs({ align: "center", direction: "column", justify: "center" })(_b$h || (_b$h = __template$G(["\n  height: 110px;\n"])));
function ConfirmDeleteDialog(_ref12) {
  let { id, type, action = "delete", onCancel, onConfirm } = _ref12;
  const { t } = useTranslation2(structureLocaleNamespace);
...
function PaneContextMenuButton(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(MenuButton, { button: (0, import_jsx_runtime2.jsx)(ContextMenuButton, { tone: hasCritical ? "critical" : hasCaution ? "caution" : void 0 }), id, menu: (0, import_jsx_runtime2.jsx)(Menu, { children: nodes.map((node, nodeIndex) => {
    var _a2;
...
var _a$F;
var Root$e = ut(Layer)(_a$F || (_a$F = __template$F(["\n  position: relative;\n  width: 1px;\n  min-width: 1px;\n\n  &:before {\n    content: '';\n    display: block;\n    position: absolute;\n    top: 0;\n    left: 0;\n    bottom: 0;\n    width: 1px;\n    background-color: var(--card-border-color);\n  }\n\n  &:not([data-disabled]) {\n    cursor: ew-resize;\n    width: 9px;\n    min-width: 9px;\n    margin: 0 -4px;\n\n    &:before {\n      left: 4px;\n    }\n\n    &:after {\n      content: '';\n      display: block;\n      position: absolute;\n      top: 0;\n      left: 0;\n      width: 9px;\n      bottom: 0;\n      background-color: var(--card-border-color);\n      opacity: 0;\n      transition: opacity 150ms;\n    }\n\n    &[data-dragging]:after,\n    &:hover:after {\n      opacity: 0.2;\n    }\n  }\n"])));
function PaneDivider(_ref13) {
  let { disabled, element } = _ref13;
...
var _a$E;
var Root$d = ut(Card)(_a$E || (_a$E = __template$E(["\n  outline: none;\n\n  // NOTE: This will render a border to the right side of each pane\n  // without taking up physical space.\n  box-shadow: 1px 0 0 var(--card-border-color);\n"])));
...
var _a$D;
var Root$c = ut(Card)(_a$D || (_a$D = __template$D(["\n  position: relative;\n  outline: none;\n"])));
...
var _a$C;
var _b$g;
var Root$b = ut(Layer)(_a$C || (_a$C = __template$C(["\n  position: sticky;\n  bottom: 0;\n\n  &:before {\n    content: '';\n    display: block;\n    position: absolute;\n    left: 0;\n    right: 0;\n    top: -1px;\n    border-bottom: 1px solid var(--card-border-color);\n  }\n"])));
var RootCard$1 = ut(Card)(_b$g || (_b$g = __template$C(["\n  padding-bottom: env(safe-area-inset-bottom);\n"])));
...
var _e$2;
var _f$2;
var Root$a = ut(Layer)((_ref14) => {
  let { $border } = _ref14;
  return at(_a$B || (_a$B = __template$B(["\n    line-height: 0;\n    position: sticky;\n    top: 0;\n\n    &:not([data-collapsed]):after {\n      content: '';\n      display: block;\n      position: absolute;\n      left: 0;\n      right: 0;\n      bottom: -1px;\n      border-bottom: 1px solid ", ";\n      opacity: 1;\n    }\n  "])), $border ? "var(--card-border-color)" : "transparent");
});
var Layout = ut(Flex)(_b$f || (_b$f = __template$B(["\n  transform-origin: calc(51px / 2);\n\n  [data-collapsed] > div > & {\n    transform: rotate(90deg);\n  }\n"])));
var TitleCard = ut(Card)((_ref15) => {
  let { theme } = _ref15;
  const { fg, bg } = theme.sanity.color.card.enabled;
  return at(_c$7 || (_c$7 = __template$B(["\n    background-color: ", ";\n\n    [data-ui='Text'] {\n      color: ", ";\n    }\n  "])), bg, fg);
});
var TitleTextSkeleton = ut(TextSkeleton)(_d$4 || (_d$4 = __template$B(["\n  width: 66%;\n  max-width: 175px;\n"])));
var TitleText = ut(Text)(_e$2 || (_e$2 = __template$B(["\n  cursor: default;\n  outline: none;\n"])));
var TabsBox = ut(Box)((_ref16) => {
  let { theme } = _ref16;
  const { color, space } = theme.sanity;
  return at(_f$2 || (_f$2 = __template$B(["\n    overflow: hidden;\n    overflow: clip;\n    position: relative;\n\n    & > div {\n      white-space: nowrap;\n      overflow: auto;\n      /* Hide scrollbars */\n      scrollbar-width: none;\n      &::-webkit-scrollbar {\n        width: 0;\n        height: 0;\n      }\n    }\n\n    /* right padding */\n    & > div:after {\n      content: '';\n      display: inline-block;\n      top: 0;\n      right: 0;\n      bottom: 0;\n      width: ", "px;\n      height: 1px;\n    }\n\n    /* Gradient that makes it look like tabs disappear into nothing (looks nicer) */\n    &:after {\n      content: '';\n      display: block;\n      position: absolute;\n      top: 0;\n      right: 0;\n      bottom: 0;\n      background: linear-gradient(to right, ", ", var(--card-bg-color));\n      width: ", "px;\n      pointer-events: none;\n    }\n  "])), space[3], rgba(color.base.bg, 0), space[3]);
});
...
var _a$A;
var Root$9 = ut(Card)(_a$A || (_a$A = __template$A(["\n  transition: opacity 200ms;\n  position: relative;\n  z-index: 1;\n  padding-left: env(safe-area-inset-left);\n  padding-right: env(safe-area-inset-right);\n  opacity: 0;\n\n  &:not([hidden]) {\n    display: flex;\n  }\n\n  &:not([data-collapsed]) {\n    overflow: auto;\n  }\n\n  &[data-mounted] {\n    opacity: 1;\n  }\n\n  &[data-resizing] {\n    pointer-events: none;\n  }\n"])));
...
function InsufficientPermissionsMessageTooltip(_ref17) {
  let { reveal, context, loading, children } = _ref17;
...
var PaneHeaderActions = (0, import_react3.memo)(function PaneHeaderActions2(props) {
  ...
  const initialValueTemplateItemFromMenuItems = (0, import_react3.useMemo)(() => {
    return menuItems.map((item, menuItemIndex) => {
      ...
      let { initialDocumentId, item, template: template2, menuItemIndex, templateParams } = _ref21;
...
var DeleteAction = (_ref22) => {
  let { id, type, draft, onComplete } = _ref22;
...
var DiscardChangesAction = (_ref23) => {
  let { id, type, published, liveEdit, onComplete } = _ref23;
...
var HistoryRestoreAction = (_ref25) => {
  let { id, type, revision, onComplete } = _ref25;
...
function AlreadyPublished(_ref26) {
  let { publishedAt } = _ref26;
  const { t } = useTranslation2(structureLocaleNamespace);
...
var UnpublishAction = (_ref27) => {
  let { id, type, draft, onComplete, liveEdit } = _ref27;
...
var commentsUsEnglishLocaleBundle = defineLocaleResourceBundle({ locale: "en-US", namespace: commentsLocaleNamespace, resources: () => import("./resources-YfoVZEUy-72ZR3OP7.js") });
...
var _a$z;
var StyledAvatar = ut(Avatar)(_a$z || (_a$z = __template$z(["\n  svg > ellipse {\n    stroke: transparent;\n  }\n"])));
...
var _a$x;
var NormalText = ut(Text)(_a$x || (_a$x = __template$x(["\n  word-break: break-word;\n"])));
...
var SendIcon = (0, import_react3.forwardRef)(function Icon(props, ref) {
...
var MentionIcon = (0, import_react3.forwardRef)(function Icon2(props, ref) {
...
var AddCommentIcon = (0, import_react3.forwardRef)(function Icon3(props, ref) {
...
var CommentIcon2 = (0, import_react3.forwardRef)(function Icon4(props, ref) {
...
var ReactionIcon = (0, import_react3.forwardRef)(function Icon5(props, ref) {
...
var _a$v;
var InnerFlex = ut(Flex)(_a$v || (_a$v = __template$v([""])));
...
var MentionsMenu = import_react3.default.forwardRef(function MentionsMenu2(props, ref) {
  const { t } = useTranslation2(commentsLocaleNamespace);
...
var StyledPopover$1 = ut(Popover2)((_ref51) => {
  let { theme } = _ref51;
...
var _a$t;
var _b$d;
var EditableWrap = ut(Box)(_a$t || (_a$t = __template$t(["\n  max-height: 20vh;\n  overflow-y: auto;\n"])));
var ButtonDivider = ut(MenuDivider)({ height: 20, width: 1 });
var RootCard = ut(Card)((_ref52) => {
  let { theme } = _ref52;
...
var _d$3;
var TEXT_SIZE = 1;
var ContentStack$1 = ut(Stack)(_a$r || (_a$r = __template$r(["\n  max-width: 180px;\n"])));
var TextGroup = ut.div(_b$c || (_b$c = __template$r(["\n  display: inline-block;\n"])));
var InlineText = ut(Text).attrs({ size: TEXT_SIZE })(_c$6 || (_c$6 = __template$r(["\n  display: inline-block !important;\n\n  & > span {\n    white-space: break-spaces;\n  }\n"])));
var TextBox = ut(Box)(_d$3 || (_d$3 = __template$r(["\n  line-height: 1;\n  text-align: center;\n"])));
...
function FormattedUserList(_ref53) {
  let { currentUserId, userIds } = _ref53;
...
var _a$q;
var TransparentCard = ut(Card)(_a$q || (_a$q = __template$q(["\n  background: none;\n"])));
function groupReactionsByName(reactions) {
  ...
  const sorted = Object.entries(grouped).sort((_ref55, _ref56) => {
    let [nameA] = _ref55;
    let [nameB] = _ref56;
...
var renderMenuButton$1 = (_ref57) => {
  let { open, tooltipContent } = _ref57;
...
var CommentReactionsBar = import_react3.default.memo(function CommentReactionsBar2(props) {
  ...
  const sortedReactions = (0, import_react3.useMemo)(() => {
    const sorted = groupedReactions.sort((_ref59, _ref60) => {
      let [nameA] = _ref59;
      let [nameB] = _ref60;
    ...
    sortOrder.current = sorted.map((_ref61) => {
      let [name] = _ref61;
      return name;
    });
    return sorted;
  }, [groupedReactions]);
  return (0, import_jsx_runtime2.jsx)(Flex, { align: "center", gap: 1, wrap: "wrap", children: (0, import_jsx_runtime2.jsxs)(TooltipDelayGroupProvider, { children: [sortedReactions.map((_ref62) => {
    let [name, reactionsList] = _ref62;
...
var _a$p;
var renderMenuButton = (_ref63) => {
  let { open, tooltipContent, t } = _ref63;
...
var FloatingCard = ut(Card)(_a$p || (_a$p = __template$p(["\n  &:empty {\n    display: none;\n  }\n"])));
...
var ContextMenuBox = ut(Box)(_a$o || (_a$o = __template$o([""])));
...
var TimeText = ut(Text)((_ref64) => {
  ...
  return at(_b$b || (_b$b = __template$o(["\n    min-width: max-content;\n    --card-fg-color: ", ";\n    color: var(--card-fg-color);\n  "])), fg);
});
var InnerStack = ut(Stack)(_c$5 || (_c$5 = __template$o(["\n  transition: opacity 200ms ease;\n\n  &[data-muted='true'] {\n    transition: unset;\n    opacity: 0.5;\n  }\n"])));
var ErrorFlex = ut(Flex)(_d$2 || (_d$2 = __template$o(["\n  min-height: ", "px;\n"])), AVATAR_HEIGHT);
var RetryCardButton = ut(Card)(_e$1 || (_e$1 = __template$o(["\n  // Add not on hover\n  &:not(:hover) {\n    background-color: transparent;\n  }\n"])));
var RootStack = ut(Stack)((_ref65) => {
  let { theme } = _ref65;
  const { space } = theme.sanity;
  return at(_f$1 || (_f$1 = __template$o(["\n    position: relative;\n\n    // Only show the floating layer on hover when hover is supported.\n    // Else, the layer is always visible.\n    @media (hover: hover) {\n      ", " {\n        opacity: 0;\n        position: absolute;\n        right: 0;\n        top: 0;\n        transform: translate(", "px, -", "px);\n      }\n\n      ", " {\n        &:focus-within {\n          opacity: 1;\n        }\n      }\n\n      &:hover {\n        ", " {\n          opacity: 1;\n        }\n      }\n    }\n\n    &[data-menu-open='true'] {\n      ", " {\n        opacity: 1;\n      }\n    }\n  "])), ContextMenuBox, space[1], space[1], ContextMenuBox, ContextMenuBox, ContextMenuBox);
});
var RELATIVE_TIME_OPTIONS = { useTemporalPhrase: true };
function CommentsListItemLayout(props) {
  const { canDelete, canEdit, comment, currentUser, hasError, isParent, isRetrying, mentionOptions, mode, onCopyLink, onCreateRetry, onDelete, onEdit, onInputKeyDown, onReactionSelect, onStatusChange, readOnly } = props;
  ...
  const reactions = (0, import_react3.useMemo)(() => {
    var _a2;
    return (((_a2 = comment == null ? void 0 : comment.reactions) == null ? void 0 : _a2.filter((r) => (r == null ? void 0 : r._optimisticState) !== "removed")) || EMPTY_ARRAY$5).filter((r) => {
...
var CommentsList = import_react3.default.memo(CommentsListInner);
...
var _b$8;
var _c$3;
var Root$7 = ut(Box)(_a$k || (_a$k = __template$k(["\n  max-width: 280px;\n"])));
var fadeInKeyFrame = ht(_b$8 || (_b$8 = __template$k(["\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 1;\n  }\n"])));
var StyledPopover = ut(Popover2)(_c$3 || (_c$3 = __template$k(["\n  opacity: 0;\n  // Fade in the popover after 500ms\n  animation: ", " 200ms 500ms forwards;\n"])), fadeInKeyFrame);
...
var _a$j;
var StyledButton = ut(Button2)((_ref71) => {
  let { theme } = _ref71;
...
var Image$1 = ut.img(_a$j || (_a$j = __template$j(["\n  object-fit: cover;\n  width: 100%;\n  height: 100%;\n  height: 200px;\n"])));
...
var _a$i;
var Image = ut.img(_a$i || (_a$i = __template$i(["\n  object-fit: cover;\n  width: 100%;\n  height: 100%;\n  height: 180px;\n"])));
...
function useMentionOptions(opts) {
  ...
  const [state2, setState] = (0, import_react3.useState)(INITIAL_STATE$2);
  const list$ = (0, import_react3.useMemo)(() => {
    ...
    const grants$ = forkJoin([users$, systemGroup$]).pipe(mergeMap(async (_ref73) => {
      let [users, groups] = _ref73;
      if (!cached) {
      ...
      const grantPromises = users == null ? void 0 : users.map(async (user) => {
        ...
        const { granted } = await grantsPermissionOn(user.id, flattenedGrants, "read", documentValue);
...
function useNotificationTarget(opts) {
  ...
  const handleGetNotificationValue = (0, import_react3.useCallback)((_ref74) => {
    let { commentId } = _ref74;
...
async function createOperation(props) {
  const { activeTool, client, comment, currentUser, dataset, documentId, documentType, getNotificationValue, getThreadLength, onCreate, onCreateError, projectId, runSetup, workspace } = props;
...
function useCommentOperations(opts) {
  const { client, currentUser, dataset, documentId, documentType, getComment, getThreadLength, onCreate, onCreateError, onEdit, onRemove, onUpdate, projectId, runSetup, workspace } = opts;
  ...
  const handleCreate = (0, import_react3.useCallback)(async (comment) => {
    if (!(currentUser == null ? void 0 : currentUser.id))
      return;
    await createOperation({ activeTool, client, comment, currentUser, dataset, documentId, documentType, getNotificationValue, getThreadLength, onCreate, onCreateError, projectId, runSetup, workspace });
  }, [activeTool, client, currentUser, dataset, documentId, documentType, getNotificationValue, getThreadLength, onCreate, onCreateError, projectId, runSetup, workspace]);
...
function useCommentsSetup() {
  const ctx = (0, import_react3.useContext)(CommentsSetupContext);
  if (!ctx) {
...
var CommentsEnabledProvider = import_react3.default.memo(function CommentsEnabledProvider2(props) {
...
var QUERY$1 = "*[".concat(QUERY_FILTERS.join(" && "), "] ").concat(QUERY_PROJECTION, " | ").concat(QUERY_SORT_ORDER);
function useCommentsStore(opts) {
  ...
  const listener$ = (0, import_react3.useMemo)(() => {
    if (!client)
      return of();
    const events$ = client.observable.listen(QUERY$1, params, LISTEN_OPTIONS).pipe(catchError((err) => {
      setError(err);
      return of(err);
    }));
    return events$;
...
var CommentsProvider = (0, import_react3.memo)(function CommentsProvider2(props) {
  ...
  const mentionOptions = useMentionOptions((0, import_react3.useMemo)(() => ({ documentValue }), [documentValue]));
  ...
  }), [client, currentUser, dataset, publishedId, documentType, projectId, schemaType, workspaceName, getThreadLength, getComment, runSetup, handleOnCreate, handleOnCreateError, handleOnEdit, handleOnUpdate]));
  const ctxValue = (0, import_react3.useMemo)(() => ({ isRunningSetup, status, setStatus: handleSetStatus, getComment, isCommentsOpen, onCommentsOpen, comments: { data: threadItemsByStatus, error, loading: loading || isRunningSetup }, operation: { create: operation.create, edit: operation.edit, react: operation.react, remove: operation.remove, update: operation.update }, mentionOptions }), [error, getComment, isCommentsOpen, isRunningSetup, loading, mentionOptions, onCommentsOpen, operation.create, operation.edit, operation.react, operation.remove, operation.update, status, handleSetStatus, threadItemsByStatus]);
  return (0, import_jsx_runtime2.jsx)(CommentsContext.Provider, { value: ctxValue, children });
});
var CommentsSetupContext = (0, import_react3.createContext)(null);
...
function CommentsSetupProvider(props) {
  ...
  const [addonDatasetClient, setAddonDatasetClient] = (0, import_react3.useState)(null);
  const [isRunningSetup, setIsRunningSetup] = (0, import_react3.useState)(false);
  const getAddonDatasetName = (0, import_react3.useCallback)(async () => {
    var _a2;
  ...
  const handleCreateClient = (0, import_react3.useCallback)((addonDatasetName) => {
  ...
  const handleRunSetup = (0, import_react3.useCallback)(async (comment) => {
  ...
  const ctxValue = (0, import_react3.useMemo)(() => ({ client: addonDatasetClient, runSetup: handleRunSetup, isRunningSetup }), [addonDatasetClient, handleRunSetup, isRunningSetup]);
...
var CommentsSelectedPathProvider = import_react3.default.memo(function CommentsSelectedPathProvider2(props) {
  const { children } = props;
...
var QUERY = '*[_type == "upsellUI" && id == "comments-upsell"][0]{\n    ...,\n   image {\n       asset-> { url, altText }\n     },\n     descriptionText[]{\n       ...,\n       _type == "iconAndText" => {\n         ...,\n         icon {\n           "url": asset->.url\n         }\n       },\n       _type == "block" => {\n         ...,\n           children[] {\n             ...,\n             _type == "inlineIcon" => {\n               icon {"url": asset->.url}\n             }\n         }\n       }\n     }\n }';
var UPSELL_CLIENT = { dataset: "upsell-public-production", projectId: "pyrmmpch", withCredentials: false, useCdn: true };
...
function CommentsInspectorInner(props) {
  ...
  const { comments: comments2, getComment, isRunningSetup, mentionOptions, setStatus, status, operation } = useComments();
  const { isTopLayer } = useLayer();
...
var HighlightDiv = ut(motion.div)((_ref75) => {
  let { theme } = _ref75;
...
function CommentFieldInner(props) {
  ...
  const currentUser = useCurrentUser();
  const { comments: comments2, isCommentsOpen, isRunningSetup, mentionOptions, onCommentsOpen, operation, setStatus, status } = useComments();
...
function UserAvatarStack(_ref76) {
  let { maxLength, userIds } = _ref76;
...
var _e;
var _f;
var IconWrapper = ut(Flex)((_ref77) => {
  let { theme } = _ref77;
  var _a2;
...
var Root$5 = ut(Button)((_ref78) => {
  let { $selected, $disabled } = _ref78;
...
function TimelineItem(_ref80) {
  let { chunk, isFirst, isLast, isLatest, isSelected, onSelect, timestamp, type } = _ref80;
...
var Root$4 = ut(Box)((_ref81) => {
  let { $visible } = _ref81;
  return at(_d || (_d = __template$c(["\n    opacity: 0;\n    pointer-events: none;\n\n    ", "\n  "])), $visible && at(_c$1 || (_c$1 = __template$c(["\n      opacity: 1;\n      pointer-events: auto;\n    "]))));
});
var Timeline = (_ref82) => {
  let { chunks, disabledBeforeFirstChunk, hasMoreChunks, lastChunk, onLoadMore, onSelect, firstChunk } = _ref82;
  ...
  const renderItem2 = (0, import_react3.useCallback)((chunk, _ref83) => {
    let { activeIndex } = _ref83;
...
function TimelineMenu(_ref84) {
  let { chunk, mode, placement } = _ref84;
...
function Content$1(_ref86) {
  let { error, diff, documentContext, loading, schemaType } = _ref86;
  if (error) {
...
}, component: ChangesInspector, onClose: (_ref87) => {
  let { params } = _ref87;
...
var structureTool = definePlugin((options) => {
  ...
  return { name: "sanity/structure", document: { actions: (prevActions) => {
    ...
    icon,
    component: (0, import_react3.lazy)(() => import("./index-otefcaF1-NU2NNXLX.js")),
...
function getOrderingMenuItem(context, _ref89, extendedProjection) {
  let { by, title, i18n } = _ref89;
...
function StructureToolProvider(_ref97) {
...
var DocumentOperationResults = (0, import_react3.memo)(function DocumentOperationResults2() {
  ...
  const paneRouter = usePaneRouter();
  const { t } = useTranslation2(structureLocaleNamespace);
  const documentTitleBase = (displayed == null ? void 0 : displayed.title) || t("panes.document-operation-results.operation-undefined-title");
...
function useStructureToolSetting(namespace, key, defaultValue) {
  ...
  const structureToolSettings = (0, import_react3.useMemo)(() => settingsStore.forNamespace("structure-tool"), [settingsStore]);
...
var _a$6;
var JSONInspectorWrapper = ut.div((_ref98) => {
  let { theme } = _ref98;
...
function DeletedDocumentBanner(_ref100) {
  let { revisionId } = _ref100;
...
function PermissionCheckBanner(_ref101) {
  let { granted, requiredPermission } = _ref101;
  const currentUser = useCurrentUser();
...
var FormHeader = (_ref104) => {
  let { documentId, schemaType, title } = _ref104;
  var _a2;
...
var Scroller = ut(ScrollContainer)((_ref105) => {
...
function useResizeObserver(_ref108) {
  let { element, onResize } = _ref108;
...
function DocumentBadgesInner(_ref109) {
  let { states } = _ref109;
  if (states.length === 0) {
    return null;
  }
...
function DocumentBadges() {
  ...
  if (!editState || !badges)
    return null;
  return (0, import_jsx_runtime2.jsx)(RenderBadgeCollectionState, { badges, badgeProps: editState, children: (_ref110) => {
    let { states } = _ref110;
...
function DocumentStatusLine(_ref111) {
  let { singleLine } = _ref111;
...
var DocumentActionShortcuts = import_react3.default.memo((props) => {
  ...
  if (!actionProps || !actions)
    return null;
  return (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actionProps, actions, children: (_ref112) => {
    let { states } = _ref112;
...
function getInspectorItems(_ref113) {
  let { currentInspector, hasValue, inspectors: inspectors2, inspectorMenuItems } = _ref113;
...
function getInspectItem(_ref114) {
  let { hasValue, t } = _ref114;
...
function getProductionPreviewItem(_ref115) {
  let { previewUrl, t } = _ref115;
  if (!previewUrl)
    return null;
...
function DocumentListPaneContent(props) {
  ...
  const renderItem2 = (0, import_react3.useCallback)((item, _ref116) => {
    let { activeIndex } = _ref116;
...
var DocumentListPaneHeader = (0, import_react3.memo)((_ref118) => {
  let { contentAfter, index, initialValueTemplates = [], menuItemGroups = [], menuItems = [], setLayout, setSortOrder, title } = _ref118;
  const { features } = useStructureTool();
  const { collapsed, isLast } = usePane();
  const tabIndex = isLast && !collapsed ? -1 : 0;
  const actionHandlers = (0, import_react3.useMemo)(() => {
    return { setLayout: (_ref119) => {
      let { layout: value } = _ref119;
      setLayout(value);
    }, setSortOrder: (sort) => {
      setSortOrder(sort);
    } };
...
//# sourceMappingURL=chunk-7AMIU7LY.js.map
