...
// node_modules/@sanity/vision/lib/_chunks/index-JP19GHgF.js
...
var visionUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources-bPLLJ09x-DVWGFECT.js")
});
var visionTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      component: (0, import_react.lazy)(() => import("./SanityVision-rZQ4XjJn-4PZVB5SE.js")),
      options: config,
      router: route.create("/*")
    }],
    i18n: {
...
//# sourceMappingURL=chunk-BLDNGEGF.js.map
