...
var index = require('./index-MzAxQLl8.js');
...
function clearLocalStorage() {
  ...
  for (let i = 0; i < localStorage.length; i++) {
    ...
    if (key == null ? void 0 : key.startsWith(keyPrefix)) {
...
function validateApiVersion(apiVersion) {
  ...
  const isValidApiVersion = parseableApiVersion.length > 0 && (parseableApiVersion === "X" || parseableApiVersion === "1" || /^\d{4}-\d{2}-\d{2}$/.test(parseableApiVersion) && !isNaN(Date.parse(parseableApiVersion)));
...
var _a$3, _b$1;
const PerspectivePopoverContent = styled__default.default(ui.Box)(_a$3 || (_a$3 = __template$3(["\n  /* This limits the width of the popover content */\n  max-width: 240px;\n"])));
const PerspectivePopoverLink = styled__default.default.a(_b$1 || (_b$1 = __template$3(["\n  cursor: pointer;\n  margin-right: auto;\n"])));
...
function QueryErrorDetails(_ref5) {
  let {
    error
  } = _ref5;
  const {
...
var _a$1;
const ResultViewWrapper = styled__default.default.div(_ref6 => {
  let {
    theme
  } = _ref6;
  const {
...
class VisionErrorBoundary extends React.Component {
  constructor(props) {
    super(props);
    this.handleRetryRender = () => this.setState(prev => ({
      error: null,
        ...
        children: /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
          ...
          children: [/* @__PURE__ */jsxRuntime.jsx("div", {
            ...
            children: /* @__PURE__ */jsxRuntime.jsx(ui.Stack, {
              space: 4,
              children: message && /* @__PURE__ */jsxRuntime.jsx(ui.Code, {
                size: 1,
...
function SanityVision(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(VisionErrorBoundary, {
    children: /* @__PURE__ */jsxRuntime.jsx(VisionContainer, {
      client,
      config
    })
  });
...
//# sourceMappingURL=SanityVision-ltWZ43A6.js.map
