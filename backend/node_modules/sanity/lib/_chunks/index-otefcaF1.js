...
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useStructureTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, StructureToolProvider } from './structure-gHZwXvhJ.js';
...
import { Button } from './TooltipDelayGroupProvider-e1ApGn-p.js';
...
const paneMap = {
  component: lazy(() => import('./index-a-sWfEMi.js')),
  document: lazy(() => import('./pane-nb11k62L.js')),
  documentList: lazy(() => import('./pane-3fuoF944.js')),
  list: lazy(() => import('./index-USaWq-Uo.js'))
};
...
//# sourceMappingURL=index-otefcaF1.js.map
